    ...
    <TeacherLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div
                    class="bg-white relative dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg block sm:flex sm:items-center">
                    <div
                        class="aspect-square h-full sm:h-64 sm:w-64 border flex-shrink-0 rounded-lg m-4 grid items-end text-gray-800 dark:text-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <PrimaryButton class="block bottom-0 mt-8 mr-2" @click="downloadFile">Download File
                        </PrimaryButton>
